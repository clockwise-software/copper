...
def surnameSearch():
	...
	if request.method == 'POST':
		try:
			...
			city = request.form.get('City', default="Error") # Get city data from search page
			state_prov = request.form.get('State/Province', default="Error") # Get state/province data from search page
			skill = request.form.get('Skill', default="Error") # Get skill data from search page
			licenses = request.form.get('Registered Licenses', default="Error") # Get license data from search page
